...
{
	XMFLOAT3 rightAxis = GetRightAxis();
...
void Transform::Rotate(const XMFLOAT3& eularAnglesInRadian)
{
	XMVECTOR newRotationVec = XMVectorAdd(XMLoadFloat3(&m_Rotation), XMLoadFloat3(&eularAnglesInRadian));
...
void Transform::LookTo(const DirectX::XMFLOAT3& direction, const DirectX::XMFLOAT3& up /*= { 0.f,1.f,0.f }*/)
{
