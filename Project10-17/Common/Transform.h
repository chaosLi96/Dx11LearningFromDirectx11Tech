...
public:
	...
	void Rotate(const DirectX::XMFLOAT3& eularAnglesInRadian);
	...
	void LookAt(const DirectX::XMFLOAT3& target, const DirectX::XMFLOAT3& up = { 0.f,1.f,0.f });
	void LookTo(const DirectX::XMFLOAT3& direction, const DirectX::XMFLOAT3& up = { 0.f,1.f,0.f });
